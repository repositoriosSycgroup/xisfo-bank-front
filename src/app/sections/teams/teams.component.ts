...
export class TeamsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  teams: any = [
    {"id": 0, "img": "../../../assets/img/Team/james_moreno.webp", "name": "Desarrollador de Negocios Internacionales"},
    {"id": 2, "img": "../../../assets/img/Team/carlos_quintero.webp", "name": "CEO"},
    {"id": 4, "img": "../../../assets/img/Team/stefania_castano.webp", "name": "Gerente Administrativa"},
    {"id": 6, "img": "../../../assets/img/Team/don_carlos.webp", "name": "Gerente Financiero"},
    {"id": 8, "img": "../../../assets/img/Team/vanesa_parra.webp", "name": "Comunicaciones y Relaciones Públicas"},
    {"id": 10, "img": "../../../assets/img/Team/danitza_naranjo.webp", "name": "Líder Comercial"},
    {"id": 12, "img": "../../../assets/img/Team/yesica_guzman.webp", "name": "Directora de Mercadeo"},
    {"id": 14, "img": "../../../assets/img/Team/jhon_santos.webp", "name": "Líder de T.I"},
    {"id": 16, "img": "../../../assets/img/Team/aleja_marin.webp", "name": "Directora de Recursos Humanos"},
